...
public class SmallPage extends AppCompatActivity {
    EditText ed1,ed2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_small_page);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    if(n1>n2){
                        Toast.makeText(getApplicationContext(),String.valueOf(n2)+" is Smallest", Toast.LENGTH_SHORT).show();
                    } else if(n2>n1) {
                        Toast.makeText(getApplicationContext(),String.valueOf(n1)+" is Smallest", Toast.LENGTH_SHORT).show();
                    }
                    else {
